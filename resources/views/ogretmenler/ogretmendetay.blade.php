              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="{{ asset('/bower_components/admin-lte/dist/img/user3-128x128.jpg') }}" alt="user image">
                        <span class="username">
                  ...
                  <li>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-footer">
                        <a class="btn btn-warning btn-xs">Read more</a>
